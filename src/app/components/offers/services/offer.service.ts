...
export class OfferService {
  ...
  private prepareDomainItem(apiItem: any, categoryType: string) {
    ...
    return <Item> {
      ...
      normalPrice: apiItem.normalPrice,
      discountedPrice: apiItem.discountedPrice,
      normalPriceForCombo: apiItem.normalPriceForCustomCombo,
      discountedPriceForCombo: apiItem.discountedPriceForCustomCombo,
